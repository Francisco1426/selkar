                        ...
                        <form action="{{ route('procesos.update',$proceso->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                            name="nombre" id="nombre" value="{{$proceso->nombre}}" placeholder="Escriba el nombre....">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="form-control @error('descripcion') is-invalid @enderror"
                                            name="descripcion" id="descripcion" value="{{$proceso->descripcion}}" placeholder="Escriba la descripcion....">
