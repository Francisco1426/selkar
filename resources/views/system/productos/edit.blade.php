        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                <div class="panel-heading">
                    <h3 class="panel-title">Modifica Productos</h3>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre"
                                        id="nombre" value="{{$producto->nombre}}" placeholder="Escriba el nombre....">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion"
                                        value="{{$producto->descripcion}}" placeholder="Escriba la descripcion....">
                                </div>
