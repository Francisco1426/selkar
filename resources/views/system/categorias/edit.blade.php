        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                <div class="panel-heading">
                    <h3 class="panel-title">Edicicon de categorias</h3>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{$categoria->nombre}}" placeholder="Escriba el nombre....">
                                </div>
                            </div>
                            <div class="col-md-6">
