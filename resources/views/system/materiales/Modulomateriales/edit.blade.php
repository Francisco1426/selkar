        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    <form action="{{route('Modulomateriales.editar')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="search" class="form-control" name="numeroserie" id="numeroserie" placeholder="Busca el vehiculo..." value="{{ $vehiculo->numeroserie }}">
                                ...
                                <div class="row" id="detallevehiculo">
                                    ...
                                    <div class="col-md-4" hidden>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control @error('vehiculo_id') is-invalid @enderror" name="vehiculo_id" id="vehiculo_id" value="{{old('vehiculo_id') ?? $vehiculo->id}}" placeholder="" readonly>
                                        </div>
                                        @error('vehiculo_id')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nombre" id="vehiculo" value="{{old('nombre') ?? $vehiculo->nombre}}" placeholder="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="marca" id="marca" value="{{old('marca') ?? $vehiculo->marca}}" placeholder="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="producto" id="producto" value="{{old('producto') ?? $vehiculo->producto->nombre}}" placeholder="" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="lista-materiales" class="table table-striped"">
                                ...
                                <tbody>
                                    @if(old('id_material'))
                                        ...
                                        @endforeach
                                    @else
                                        @foreach ($vehiculo->materialVehiculos as $key => $material)
                                            @php
                                                $idunico = random_int(1,1000); 

                                            @endphp
                                            <tr id="tr-material{{$idunico}}">
                                                <td>{{$material->pivot->material_id}}
                                                </td>   
                                                <td>{{$material->nombre}}</td> 
                                                <td><input type="number" class="form-control" name="cantidad_material[]" id="input-editar-material-{{$idunico}}" value="{{$material->pivot->cantidad}}" readonly></td>  
                                                <td>{{$material->medida}}</td> 
                                                <td>{{$material->pivot->vehiculo_id}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-success" onclick="modificarMaterial({{$idunico}})" id="btn-editar-material-{{$idunico}}"><i class="fas fa-edit"></i></button>
                                                    <button type="button" class="btn btn-danger" onclick="eliminarMaterial({{$idunico}})" id="btn-eliminar-material-{{$idunico}}"> <i class="fas fa-trash"></i></button>
                                                </td>
                                                ...
                                                <td hidden>
                                                    <input type="text" class="form-control" name="id_material[]" value="{{$material->pivot->material_id}}" hidden>
                                                    <input type="text" class="form-control" name="observaciones_material[]" value="{{$material->pivot->observaciones}}" hidden>
                                                    <input type="text" class="form-control" name="fecha_material[]" value="{{$material->pivot->fecha}}" hidden>
                                                    <input type="text" class="form-control" name="fases_material[]" value="{{$material->pivot->fase_id}}" hidden>
                                                    <input type="text" class="form-control" name="vehiculo_material[]" value="{{$material->pivot->vehiculo_id}}" hidden>  
                                                    <input type="text" class="form-control" name="nombre_material[]" value="{{$material->nombre}}" hidden>  
                                                    <input type="text" class="form-control" name="medida_material[]" value="{{$material->medida}}" hidden> 
                                                    <input type="text" class="form-control" name="vehiculo_material_numero[]" value="{{$material->pivot->vehiculo_id}}" hidden>    
                                                </td>
