                    ...
                    <form action="{{route('fases.update', $fase->id)}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion" value="{{$fase->descripcion}}" placeholder="Escriba el nombre....">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-11">
